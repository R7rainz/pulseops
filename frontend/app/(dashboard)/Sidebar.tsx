                        ...
                        {workspaces.length === 0 ? (
                            ...
                            workspaces.map((ws: any) => {
                                ...
                                return (
                                    <div
                                        key={ws.id}
                                        className={`group border-2 transition-colors ${isActive
                                    ...
                                    >
                                        ...
                                        <Link
                                            ...
                                            className={`flex items-center gap-3 px-3 py-3 text-sm font-bold transition-colors ${isActive
                                                    ? "text-emerald-400"
                                        ...
                                        <div className={`transition-all duration-200 overflow-hidden ${isActive
...
function NavItem({
    ...
    return (
        <Link
            href={href}
            className={`flex items-center gap-3 px-4 py-2.5 text-xs font-bold uppercase tracking-widest transition-colors ${isActive
