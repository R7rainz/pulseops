  ...
  return (
    <div>
      <div className="fade-up">
        <h1 className="font-display text-[1.75rem] font-semibold tracking-tight text-foreground">Sign in with a link</h1>
        <p className="mt-1.5 text-sm text-muted-foreground">We’ll email you a one-time sign-in link — no password needed</p>
      </div>
      ...
      <div className="fade-up mt-8" style={{ animationDelay: "80ms" }}>
        {status === "success" ? (
          ...
          <>
            <OAuthButtons label="Or use your email" />
