        ...
        <div className="glass space-y-4 rounded-lg p-6">
          ...
          {stats ? (
            <div className="space-y-4">
              ...
              <RangeBlock title="Last 24 hours" uptime={r24?.uptimePercentage} latency={r24?.averageResponseTimeMs} p95={r24?.p95ResponseTimeMs} pctClass={pctClass} />
              <RangeBlock title="Last 30 days" uptime={r30?.uptimePercentage} latency={r30?.averageResponseTimeMs} p95={r30?.p95ResponseTimeMs} pctClass={pctClass} />
            </div>
          ) : (
